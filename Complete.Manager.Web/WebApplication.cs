...
namespace Complete.Manager.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class ManagerAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Complete.Manager.Module.ManagerModule module3;
        private Complete.Manager.Module.Web.ManagerAspNetModule module4;
        ...
        public ManagerAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void ManagerAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new Complete.Manager.Module.ManagerModule();
            this.module4 = new Complete.Manager.Module.Web.ManagerAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(Complete.Manager.Module.BusinessObjects.ApplicationUser);
            // 
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(Complete.Manager.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            this.authenticationStandard1.UserLoginInfoType = typeof(Complete.Manager.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // validationModule
            //
            this.validationModule.AllowValidationDetailsAccess = false;
            // 
            // ManagerAspNetApplication
            // 
            this.ApplicationName = "Complete.Manager";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.ManagerAspNetApplication_DatabaseVersionMismatch);
